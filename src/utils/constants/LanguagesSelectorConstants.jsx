...
export const supportedLanguages = {
  ...
  elm: {
    ...
    icon: (
      <svg viewBox="0 0 128 128">
        <path fill="#efa500" d="M64 60.74l25.65-25.65h-51.3L64 60.74z"></path>
        <path
          fill="#8dd737"
          d="M7.91 4.65l25.83 25.84h56.17L64.07 4.65H7.91zM67.263 63.993l28.08-28.08 27.951 27.953-28.08 28.079z"
        ></path>
        <path fill="#60b5cc" d="M123.35 57.42V4.65H70.58l52.77 52.77z"></path>
        <path fill="#34495e" d="M60.74 64L4.65 7.91V120.1L60.74 64z"></path>
        <path
          fill="#efa500"
          d="M98.47 95.21l24.88 24.89V70.33L98.47 95.21z"
        ></path>
        <path fill="#60b5cc" d="M64 67.26L7.91 123.35h112.18L64 67.26z"></path>
      </svg>
    ),
  },
  go: {
  ...
  php: {
    ...
    icon: (
      <svg viewBox="0 0 128 128">
        ...
        <path
          fill="#fff"
          d="M91.555 55.826h3.891c3.107 0 4.186.682 4.552 1.089.61.674.724 2.097.333 4.112-.44 2.257-1.254 3.858-2.421 4.756-1.195.92-3.139 1.386-5.773 1.386h-2.786l2.204-11.342zm6.674-8.1H84.096a1.39 1.39 0 0 0-1.363 1.123l-6.558 33.739a1.39 1.39 0 0 0 1.364 1.653h7.35a1.39 1.39 0 0 0 1.363-1.124l1.525-7.846h5.15c2.911 0 5.364-.318 7.287-.944 1.978-.642 3.797-1.731 5.406-3.238a16.52 16.52 0 0 0 3.258-4.086c.832-1.487 1.428-3.147 1.775-4.931.86-4.423.162-7.964-2.076-10.524-2.216-2.537-5.697-3.823-10.35-3.823zM87.666 68.557h4.47c2.964 0 5.17-.557 6.622-1.675 1.45-1.116 2.428-2.98 2.936-5.591.487-2.508.266-4.277-.665-5.308-.93-1.03-2.791-1.546-5.583-1.546h-5.035Zm10.563-19.445c4.251 0 7.354 1.117 9.303 3.348 1.95 2.232 2.537 5.347 1.759 9.346-.32 1.648-.862 3.154-1.624 4.518-.763 1.366-1.76 2.614-2.992 3.747-1.467 1.373-3.097 2.352-4.892 2.935-1.793.584-4.078.875-6.856.875h-6.295l-1.745 8.97h-7.35l6.558-33.739h14.133"
        ></path>
        <defs>
          <radialGradient
            id="a"
  ...
  typescriptEffectSchema: {
    name: "TypeScript (EffectSchema)",
    language: "typescript-effect-schema",
    languagueSyntax: "typescript",
    icon: (
      <svg viewBox="0 0 128 128">
        <path fill="#fff" d="M22.67 47h99.67v73.67H22.67z"></path>
