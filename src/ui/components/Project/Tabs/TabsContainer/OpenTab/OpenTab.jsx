...
import HttpMethodIcon from "../../../../Global/HTTPIcons/HttpMethodIcon";
...
export default function OpenTab({ file }) {
    ...
    return (
        <div
            className={`tabs_open-tab ${currentFileId == file.id ? "tabs_current-tab" : ""
                }`}
        ...
        >
            ...
            <HttpMethodIcon method={file?.content?.type} />
            {isRename ? (
                <OpenTabRenameForm
                    setIsRename={setIsRename}
                    isRename={isRename}
